...
.. code-block:: bash
    ...
    heroku run python thedevlabsweb/manage.py syncdb --noinput --settings=config.settings
    heroku run python thedevlabsweb/manage.py migrate --settings=config.settings
    heroku run python thedevlabsweb/manage.py collectstatic --settings=config.settings
